...
const imgSize = `30`
const star1 = `<img src=${star} alt="rating in stars" height="${imgSize}" width="${imgSize}">`;
const star2 = `<img src=${star} alt="rating in stars" height="${imgSize}" width="${imgSize}"><img src=${star} alt="rating in stars" height="${imgSize}" width="${imgSize}">`;
const star3 = `<img src=${star} alt="rating in stars" height="${imgSize}" width="${imgSize}"><img src=${star} alt="rating in stars" height="${imgSize}" width="${imgSize}"><img src=${star} alt="rating in stars" height="${imgSize}" width="${imgSize}">`;
const star4 = `<img src=${star} alt="rating in stars" height="${imgSize}" width="${imgSize}"><img src=${star} alt="rating in stars" height="${imgSize}" width="${imgSize}"><img src=${star} alt="rating in stars" height="${imgSize}" width="${imgSize}"><img src=${star} alt="rating in stars" height="${imgSize}" width="${imgSize}">`;
const star5 = `<img src=${star} alt="rating in stars" height="${imgSize}" width="${imgSize}"><img src=${star} alt="rating in stars" height="${imgSize}" width="${imgSize}"><img src=${star} alt="rating in stars" height="${imgSize}" width="${imgSize}"><img src=${star} alt="rating in stars" height="${imgSize}" width="${imgSize}"><img src=${star} alt="rating in stars" height="${imgSize}" width="${imgSize}">`;
      ...
      <li>
          ...
          <div class="moreInfo" id = "${store.filtered[i].id}">
            ...
            <span class="visitSite">Visit Site</span>
              ...
              <h3>${currentStar}</h3>
              <button class = "removeBookmark" id ="remove"><img src = ${trash} alt="trash icon" height = "50" width="50"></button>
            </div>
